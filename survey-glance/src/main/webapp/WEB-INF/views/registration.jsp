			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="ace-icon fa fa-leaf green"></i> <span class="red">Survey</span>
								<span class="white" id="id-text2">Application</span>
							</h1>
							<h4 class="blue" id="id-company-text">&copy; surveyglance.in</h4>
						</div>
							...
							<div id="signup-box" class="signup-box visible widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<c:url var="registerUrl" value="/registerNewUser"/>
										<form:form name="registerForm" modelAttribute="registerForm"
									...
									<c:url var="login" value="/login"/>
										<a href="${login} " class="back-to-login-link"> <i
